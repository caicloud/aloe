#!/bin/sh
set -e
# Code generated by godownloader on 2019-01-22T09:24:02Z. DO NOT EDIT.
#
...
execute() {
  ...
  install -d "${BINDIR}"
  for binexe in "gometalinter" "gocyclo" "nakedret" "misspell" "gosec" "golint" "ineffassign" "goconst" "errcheck" "maligned" "unconvert" "dupl" "structcheck" "varcheck" "safesql" "deadcode" "lll" "goimports" "gotype" "gosimple" "megacheck" "staticcheck" "interfacer" "unparam" "gochecknoinits" "gochecknoglobals" ; do
    if [ "$OS" = "windows" ]; then
      binexe="${binexe}.exe"
    fi
